 ...
 *
 */
public class InfoController implements ModalControllerInterface<TreeniPaivaKirja> {
    
    private TreeniPaivaKirja treenipaivakirja;
    
    /**
     * 
     * @param treenipaivakirja joo
     * @param ikkunalleNimi Antaa avattavalle dokumentille nimen ikkunaan
     */
    public static void avaaInfo(TreeniPaivaKirja treenipaivakirja, String ikkunalleNimi) {
